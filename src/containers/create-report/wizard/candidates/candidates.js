...
export const filterCandidates = (candidates, searchItem) => {
        ...
        return (
            <div className="row">
                ...
                <div className="col-4 col-sm-3 mt-1">
                    <Button type="btnNext" isDisabled={next} action={incrementPhase} newLocation={Routes.CREATE_REPORT_COMPANIES} />
                </div>
